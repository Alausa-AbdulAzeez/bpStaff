            ...
            <div className='basicDetailsWrapper'>
              {candidateResults?.map((candidateResult, index) => {
                ...
                return (
                  ...
                  (candidateResult?.testName === 'Chest X-ray' ||
                  candidateResult?.testName === 'Abnominal scan' ||
                  candidateResult?.testName === 'ECG' ? (
                    <div className='rejectedResultsTextAreaSingleInput'>
                      <p>{candidateResult?.testName}</p>
                      <div className='rejectedResultsTextAreaInputWrapper'>
                        <textarea
                          value={candidateResult?.result}
                          type='text'
                          className='rejectedResultsSpecialTextArea'
                          onChange={(e) =>
